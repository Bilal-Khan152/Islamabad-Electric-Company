...
const ConsumerServiceManual = () => {
  return (
    <div className='  mt-8'>
        <div>
        <p className="font-bold  md:text-[16px] 2xl:text-3xl text-blue-900 Font-Family-Custom-Class">Consumer Sevice Manual</p>
      </div>
    <div className='w-[100%] mt-1 lg:px-3 px-1 bg-[#ecf0f1] py-3  min-h-[82px] border-[1px] border-blue-900 rounded-md shadow-lg'>
